...
proc create_root_design { parentCell } {
 ...
 ] [get_bd_intf_pins /xillybus_ip_0/xillybus_S_AXI]
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {2} \
   CONFIG.MAX_BURST_LENGTH {16} \
 ] [get_bd_intf_pins /xillyvga_0/m_axi]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins xillyvga_0/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins xillybus_lite_0/S_AXI]
